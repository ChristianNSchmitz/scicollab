...
import { getMockProfile, getUnreadCount, getNotificationsWithReadState } from "@/lib/mock-db";
...
export default function NavBar() {
  ...
  useEffect(() => {
    ...
    setProfile({ full_name: p.full_name, avatar_initials: p.avatar_initials || p.full_name?.[0]?.toUpperCase() || "R", avatar_color: p.avatar_color || "bg-slate-600" });
